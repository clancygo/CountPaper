...
test_sources=("$script_dir/CountPaper.swift" "$script_dir"/Ledger*.swift "$script_dir"/Core/*.swift "$script_dir"/Documents/*.swift "$script_dir"/UI/*.swift "$script_dir/Tests/LedgerParserTests.swift")
